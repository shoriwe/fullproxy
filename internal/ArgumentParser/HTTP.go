...
func HTTPArguments() (*string, *string, []byte, []byte, *bool, *bool, [2]string, [2]string, *string, *string) {
	...
	return host, port, []byte(*username), []byte(*password), slave, tls, [2]string{*inboundWhitelist, *inboundBlacklist}, [2]string{*outboundWhitelist, *outboundBlacklist}, commandAuth, databaseAuth
}
